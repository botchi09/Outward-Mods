...
namespace BetterTargeting
{
    public class ModLoader : PartialityMod
    {
        ...
        public override void OnEnable()
        {
            ...
            var obj = new GameObject("BetterTargeting");
            GameObject.DontDestroyOnLoad(obj);

            obj.AddComponent<LockOnFix>();
        }
    }

    public class LockOnFix : MonoBehaviour
    {
        ...
        private void UpdateTargetingHook(On.LocalCharacterControl.orig_UpdateTargeting orig, LocalCharacterControl self)
        {
			...
			// Not sure what this is for, and does this code even make sense?
			// I think it's used for some kind of dev debugging. Just removing for now anyway.

			//self.m_freeAimLockingPoint.ShowGizmos = (self.m_wasFreeAiming = self.m_debugFreeAim);
		}
    }
